...
- When a rule applies only to a specific language, it belongs in the language-specific skill (e.g., `java-best-practices`, `typescript-best-practices`), not in the base `CLAUDE.md`.
