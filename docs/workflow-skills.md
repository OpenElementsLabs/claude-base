...
- The full structure and file formats are defined in [`_workflow-shared/spec-driven-development.md`](../skills/_workflow-shared/spec-driven-development.md), which the spec workflows load on demand.
