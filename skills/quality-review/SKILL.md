...
Read the convention documents that apply to the project. Determine which are relevant based on the languages and files in the changeset. These conventions ship with this plugin — **read each one that applies; it is the authoritative source and overrides the baseline below**:

- Always: `${CLAUDE_PLUGIN_ROOT}/conventions/software-quality.md` — applies to all projects
...
- For security-sensitive changes: `${CLAUDE_PLUGIN_ROOT}/conventions/security.md`
