...
- New features must reach at least **70% test coverage** on the added or changed code (see [software-quality.md](${CLAUDE_PLUGIN_ROOT}/conventions/software-quality.md)); measure with `pnpm test --coverage`
