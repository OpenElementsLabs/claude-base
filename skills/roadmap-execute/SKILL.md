...
- If specs already exist and just need implementation — use the bundled `${CLAUDE_PLUGIN_ROOT}/skills/roadmap-execute/automated-spec-implementation-prompt.md` directly.
