...
Before performing any review or setup task, **read all convention documents first** to have full knowledge of Open Elements standards. The convention documents ship with this plugin under `${CLAUDE_PLUGIN_ROOT}/conventions/`:

1. Read all of the following files:
   - `${CLAUDE_PLUGIN_ROOT}/conventions/software-quality.md` — API design, technical integrity, namespace, SBOM, CI
